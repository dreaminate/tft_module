...
from tft.data.loaders import get_dataloaders
from tft.models.tft_module import MyTFTModule


def extract_gating_from_ckpt(
    ckpt_path: str,
    model_cfg_path: str = "configs/model_config.yaml",
    weights_cfg_path: str = "configs/weights_config.yaml",
    max_batches: int = 50,
) -> pd.DataFrame:
    import yaml
