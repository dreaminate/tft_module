...
Usage:
  python src/csv2Pkl.py --config pipelines/configs/fuse_fundamentals.yaml --which full
  python src/csv2Pkl.py --config pipelines/configs/fuse_fundamentals.yaml --which slim
"""
