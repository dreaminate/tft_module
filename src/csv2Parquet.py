...
DST_FILE = Path("data/parquet_merged/full_merged.parquet")  # 输出 parquet 文件
SELECTED_PERIODS = ["1h", "4h", "1d"]  # 你想保留的周期，None 表示不过滤

def convert_full_merged_csv(src_file: Path, dst_file: Path, selected_periods=None):
...
if __name__ == "__main__":
    convert_full_merged_csv(SRC_FILE, DST_FILE, SELECTED_PERIODS)
#  python src/csv2Parquet.py