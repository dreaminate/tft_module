...
if __name__ == "__main__":
    ...
    parser.add_argument("--symbols", nargs="*", default=["BTC_USDT", "ETH_USDT", "BNB_USDT"], help="币种列表")
...
# python src/merged.py --base_dir data/crypto_targeted_and_indicated --output data/merged/full_merged.csv --symbols BTC_USDT ETH_USDT BNB_USDT --periods 1h 4h 1d